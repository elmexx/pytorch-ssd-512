...
parser.add_argument('--net', default="vgg16-ssd", help="The network architecture, it can be mb1-ssd (aka ssd-mobilenet), mb1-lite-ssd, mb2-ssd-lite or vgg16-ssd.")
...
parser.add_argument('--model-dir', type=str, default='./models', help="directory to look for the input PyTorch model in, and export the converted ONNX model to (if --output doesn't specify a directory)")
