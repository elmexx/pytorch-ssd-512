...
parser.add_argument('--base-net', default='./models/vgg16_reducedfc.pth',type=str, help='Pretrained base model')
...
parser.add_argument('--base-net-lr', default=1e-4, type=float,
...
parser.add_argument('--num-workers', '--workers', default=1, type=int,
                    help='Number of workers used in dataloading')
parser.add_argument('--validation-epochs', default=2, type=int,
                    help='the number epochs between running validation')
parser.add_argument('--debug-steps', default=20, type=int,
...
def train(loader, net, criterion, optimizer, device, debug_steps=100, epoch=-1):
    ...
    for i, data in enumerate(loader):
        ...
        # print('train-confidence.shape: ',confidence.shape)
